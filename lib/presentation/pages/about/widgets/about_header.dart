...
class AboutDescription extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Use bodyLarge for main description, matching previous font size logic
    TextStyle? style = textTheme.bodyLarge?.copyWith(
      fontSize: responsiveSize(context, Sizes.TEXT_SIZE_16, Sizes.TEXT_SIZE_44,
          md: Sizes.TEXT_SIZE_34),
      height: 1.2,
